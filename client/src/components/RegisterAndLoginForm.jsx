      ...
      <form className="w-64 mx-auto mb-12" onSubmit={handleSubmit}>
        ...
        <div className="text-center mt-2">
          {isLoginOrRegister === 'register' && (
            <div>
              Already a member?
              <button className="ml-1 font-bold underline" onClick={() => setIsLoginOrRegister('login')}>
                Login here
              </button>
            </div>
          )}
          {isLoginOrRegister === 'login' && (
            <div>
              ...
              <button className="ml-1 font-bold underline" onClick={() => setIsLoginOrRegister('register')}>
                Register
              </button>
            </div>
          )}
